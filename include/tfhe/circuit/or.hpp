...
#ifndef TFHE_CIRCUIT_OR_HPP
#define TFHE_CIRCUIT_OR_HPP
...
// Wraps tfhe::gate::HomOr -- see tfhe/circuit/and.hpp's own doc comment,
...
class Or {
 public:
  ...
  Or() = default;
  explicit Or(const BootstrapKey<rTorus, N, l, n>& bk) : bk_(&bk) {}
